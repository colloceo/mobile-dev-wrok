...
class PreferencesManager(context: Context) {
    ...
    var preferredCurrency: String
        get() = prefs.getString(KEY_PREFERRED_CURRENCY, DEFAULT_CURRENCY) ?: DEFAULT_CURRENCY
        set(value) = prefs.edit { putString(KEY_PREFERRED_CURRENCY, value) }

    var warningDaysBeforeDue: Int
        get() = prefs.getInt(KEY_WARNING_DAYS, DEFAULT_WARNING_DAYS)
        set(value) = prefs.edit { putInt(KEY_WARNING_DAYS, value) }
